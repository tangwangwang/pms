    ...
    var y = function () {
        var e = f.protocol, t = f.api_server, n = function (e) {
            ...
            return t = t || {}, new Promise(function (n) {
                ...
                var c = o(e), u = setTimeout(function () {
                    clearTimeout(u), window[i] = null, c.remove(), n({code: "0703", msg: "Time out,Refresh Again!"})
                }, 1e4);
                window[i] = function () {
        ...
        getConfig: function (e) {
            return y("/config", {id: e.vid, type: e.type, scene: e.scene || ""})
        }, refresh: function (e) {
            return y("/refresh", e)
        }, click: function (e) {
            return y("/click", e)
        ...
        var o = !1, c = function (e) {
            ...
            return t.add("outage", "required", "please configure outage"), t.validate(), a(e, {
                ...
                mode: "DownTime"
            }), y.setConfig(e), y(e.outage, {action: "get"}).then(function (t) {
            ...
            return l(e) ? c(e) : g.getConfig(e).then(function (t) {
                if (t.code !== m.Success) {
                    ...
                    return "0702" === t.msg && alert("Vaptcha error: " + n[t.msg]), s(n[t.msg] || t.msg), Promise.reject(t.code)
                }
                return t.type !== e.type && (t.mode = t.type, t.type = e.type), a(e, t), l(e) ? c(e) : Promise.resolve()
            })
        }, d = function (e, t) {
            ...
            var t = e.sdkName, n = e.config, r = d(n, n.js_path);
            return b(r).then(function () {
                var e = window["_" + h(t) + "Vaptcha"], r = new e(n);
                return r.vaptcha.resetCaptcha = function (e, t) {
                    a(n, t), T({sdkName: e, config: n}).then(function (e) {
                        r.destroy(), r.options = e.options, r.vaptcha = e.vaptcha, e.render(), "character" === n.mode && ["click", "float", "popup"].includes(n.type) && e.vaptcha.dtClickCb({target: e.vaptcha.btnDiv})
                    })
                }, Promise.resolve(r)
            })
        }, C = function (e) {
            ...
            if (t.addValidateRules({
                ...
                var t = "theme_https." + e.css_version + ".css", n = d(e, t);
                return p(n)
            }).then(function () {
                var t = e.mode || e.type;
                return o = !1, j({sdkName: t, config: e})
            })
        };
        return function S(e) {
            return new Promise(function (t) {
